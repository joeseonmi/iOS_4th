...
//        print(dateFormmater.string(from: date))
        ...
        let tempDic:TimeLineEmotion = TimeLineEmotion(dictionary: ["cellType": "0", "date": dateFormmater.string(from: date), "emotion": emoTemp.rawValue, "comment": diaryTextView.text!, "property1": ""])
